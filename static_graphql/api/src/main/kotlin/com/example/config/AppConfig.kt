...
class AppConfig {
    ...
    var queryMappings: Map<String, String> = emptyMap()
    ...
    fun getQueryName(tableName: String): String = queryMappings[tableName] 
        ?: throw IllegalArgumentException("No query mapping found for table: $tableName")
}
